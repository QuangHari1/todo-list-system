<template>
  <div class="h-[50px] fixed top-0 left-0 right-0 bg-white z-50 border-b border-black border-opacity-20">
      ...
      <div class="flex ml-[10px]">
        ...
        <ul class="ml-4 flex items-center relative">
          <li v-for="(button, index) in buttons" :key="index" class="font-apple font-medium px-1 relative">
            <button
              :class="[
                'text-[#44546F] px-2 py-2 mt-4 mb-2 rounded transition duration-300',
